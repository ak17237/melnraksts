...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Pasākuma dati izmainīti</title>
														...
														<table class="center" cellpadding="0" cellspacing="0">
															<tr>
																<td style="line-height:0;">
																	<a target="_blank" style="text-decoration:none;" href="{{url('/')}}"><img src="<?php echo $message->embed(public_path() . '\png\latvenergo-logo.png'); ?>" border="0" style="font:bold 12px/12px Arial, Helvetica, sans-serif; color:#606060;" align="left" vspace="0" hspace="0" width="160px" alt="Latvenergo" /></a>
																</td>
															</tr>
														</table>
													</th>
														...
														<table width="100%" cellpadding="0" cellspacing="0">
															<tr>
																<td data-color="text" data-size="size navigation" data-min="10" data-max="22" data-link-style="text-decoration:none; color:#888;" class="nav" align="right" style="font:bold 13px/15px Arial, Helvetica, sans-serif; color:#888;">
																	<a target="_blank" style="text-decoration:none; color:#888;" href="{{url('/')}}">Home</a> &nbsp; &nbsp; <a target="_blank" style="text-decoration:none; color:#888;" href="{{url('/myreservations-1')}}">Manas rezervāijas</a> &nbsp; &nbsp;
																</td>
															</tr>
														</table>
													</th>
					...
					<table data-module="module-2" data-thumb="thumbnails/02.png" width="100%" cellpadding="0" cellspacing="0">
						<tr>
							<td data-bgcolor="bg-module" bgcolor="#eaeced">
								<table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
									<tr>
										<td class="img-flex"><img src="<?php echo $message->embed(public_path() . '\png\img-01.jpg'); ?>" style="vertical-align:top;" width="600" height="306" alt="" /></td>
									</tr>
									<tr>
											...
											<table width="100%" cellpadding="0" cellspacing="0">
												...
												<tr>
													<td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="center" style="font:bold 16px/25px Arial, Helvetica, sans-serif; color:#888; padding:0 0 23px;">
                                                        @if($changedate && $changeaddress) Pasākumam "{{ $event->Title }}",kuru jūs rezervējāt tika izmainīts datums un adrese. <br>
                                                        Jauns datums:  
                                                            @if(geteventdate($event->Datefrom) == geteventdate($event->Dateto)) {{-- Datuma korektra izvade --}}
                                                            <p class="content">{{ geteventdate($event->Datefrom) }}</p>
                                                            @else
                                                            <p class="content">{{ geteventdate($event->Datefrom) . '-' . geteventdate($event->Dateto) }}</p>
                                                            @endif 
                                                        Jauna adrese: {{ $event->Address }}
                                                        @elseif($changedate) 
                                                            Pasākumam {{ $event->Title }},kuru jūs rezervējāt tika izmainīts datums.<br>
                                                        Jauns datums:  
                                                            @if(geteventdate($event->Datefrom) == geteventdate($event->Dateto)) {{-- Datuma korektra izvade --}}
                                                            <p class="content">{{ geteventdate($event->Datefrom) }}</p>
                                                            @else
                                                            <p class="content">{{ geteventdate($event->Datefrom) . '-' . geteventdate($event->Dateto) }}</p>
                                                            @endif 
                                                        @elseif($changeaddress) Pasākumam {{ $event->Title }},kuru jūs rezervējāt tika izmainīta adrese.<br>
                                                        Jauna adrese: {{ $event->Address }}
                                                        @endif  
														...
														<table width="134" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
															<tr>
																<td data-bgcolor="bg-button" data-size="size button" data-min="10" data-max="16" class="btn" align="center" style="font:12px/14px Arial, Helvetica, sans-serif; color:#f8f9fb; text-transform:uppercase; mso-padding-alt:12px 10px 10px; border-radius:2px;" bgcolor="#7bb84f">
																	<a target="_blank" style="text-decoration:none; color:#f8f9fb; display:block; padding:12px 10px 10px;" href="{{route('showevent',$event->id)}}">Pasākuma lapa</a>
																</td>
															</tr>
														</table>
													</td>
                    ...
                    <table data-module="module-3" data-thumb="thumbnails/03.png" width="100%" cellpadding="0" cellspacing="0">
						<tr>
							<td data-bgcolor="bg-module" bgcolor="#eaeced">
								<table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
									<tr>
										<td class="img-flex"><img src="<?php echo $message->embed(public_path() . '\png\img-02.jpg'); ?>" style="vertical-align:top;" width="600" height="249" alt="" /></td>
									</tr>
									<tr>
											...
											<table width="100%" cellpadding="0" cellspacing="0">
												...
												<tr>
													<td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="center" style="font:16px/29px Arial, Helvetica, sans-serif; color:#888; padding:0 0 21px;">
                                                        @if($reserv->Seats > 0 && $reserv->TableSeats > 0)Jūs rezervējāt {{ $reserv->Seats }} sēdvietas un {{ $reserv->TableSeats }} sēdvietas pie galdiem.
                                                        @elseif($reserv->Seats > 0)Jūs rezervējāt {{ $reserv->Seats }} sēdvietas @if($reserv->Tickets > $reserv->Seats) un 1 stāvvietu. @endif.
                                                        @elseif($reserv->TableSeats > 0)Jūs rezervējāt {{ $reserv->TableSeats }} sēdvietas pie galdiem @if($reserv->Tickets > $reserv->TableSeats) un 1 stāvvietu. @endif.
                                                        @else Jūs rezervējāt: {{ $reserv->Tickets }} stāvvietas.
                                                        @endif
													</td>
												</tr>
												<tr>
														...
														<table width="134" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
															<tr>
																<td data-bgcolor="bg-button" data-size="size button" data-min="10" data-max="16" class="btn" align="center" style="font:12px/14px Arial, Helvetica, sans-serif; color:#f8f9fb; text-transform:uppercase; mso-padding-alt:12px 10px 10px; border-radius:2px;" bgcolor="#f5ba1c">
																	<a target="_blank" style="text-decoration:none; color:#f8f9fb; display:block; padding:12px 10px 10px;" href="{{route('showreservation',$reserv->id)}}">Rezervācijas lapa</a>
																</td>
															</tr>
														</table>
													</td>
