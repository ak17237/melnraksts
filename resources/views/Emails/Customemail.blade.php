...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Pasākuma dati izmainīti | Latvenergo pasākumu sistēma</title>
	...
	<body style="margin:0; padding:0;" bgcolor="#eaeced">
														...
														<table class="center" cellpadding="0" cellspacing="0">
															<tr>
																<td style="line-height:0;">
																	<a target="_blank" style="text-decoration:none;" href="{{url('/')}}"><img @if($preview) src="\png\latvenergo-logo.png" @else src="<?php echo $message->embed(public_path() . '\png\latvenergo-logo.png'); ?>" @endif border="0" style="font:bold 12px/12px Arial, Helvetica, sans-serif; color:#606060;" align="left" vspace="0" hspace="0" width="160px" alt="Latvenergo" /></a>
																</td>
															</tr>
														</table>
													</th>
					...
					<table data-module="module-2" data-thumb="thumbnails/02.png" width="100%" cellpadding="0" cellspacing="0">
						<tr>
							<td data-bgcolor="bg-module" bgcolor="#eaeced">
								<table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
									<tr>
										<td class="img-flex"><img @if($preview) src="\png\img-01.jpg" @else src="<?php echo $message->embed(public_path() . '\png\img-01.jpg'); ?>" @endif style="vertical-align:top;" width="600" height="306" alt="" /></td>
									</tr>
									<tr>
														...
														<table width="134" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
															<tr>
																<td data-bgcolor="bg-button" data-size="size button" data-min="10" data-max="16" class="btn" align="center" style="font:12px/14px Arial, Helvetica, sans-serif; color:#f8f9fb; text-transform:uppercase; mso-padding-alt:12px 10px 10px; border-radius:2px;" bgcolor="#7bb84f">
																	<a target="_blank" style="text-decoration:none; color:#f8f9fb; display:block; padding:12px 10px 10px;" href="{{ $button[1] }}">{{ $button[0] }}</a>
																</td>
															</tr>
														</table>
													</td>
        ...
        <tr>
                <td style="padding:0 0 20px;">
                    <table width="134" align="center" style="margin:0 auto;width:100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td data-bgcolor="bg-button" data-size="size button" data-min="10" data-max="16" class="btn" align="center" style="font:12px/14px Arial, Helvetica, sans-serif; color:#f8f9fb; text-transform:uppercase; mso-padding-alt:12px 10px 10px; border-radius:2px;" bgcolor="#7bb84f">
                                <a target="_blank" style="text-decoration:none; color:#f8f9fb; display:block; padding:12px 10px 10px;" href="javascript:window.history.go(-1);">Atpakaļ</a>
                            </td>
                        </tr>
                    </table>
                </td>
