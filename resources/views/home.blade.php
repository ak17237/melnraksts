              ...
              <table class="eventtable">
                ...
                @else
                      ...
                      <tbody>
                        ...
                        <td rowspan="2" class="top clickshow"><a class='divlink' href="{{ route('showevent',$dp1->id) }}"></a>
                          <div class="eventdate"> {{-- geteventdate,geteventd funckijas helpers.php failā lai korrekti izvadīt informāciju --}}
                        ...
                        <td rowspan="2" class="top space eventinfo clickshow">
                          <a class='divlink' href="{{ route('showevent',$dp1->id) }}"></a>
                          <h5>{{ $dp1->Title }}
                        ...
                        @if(Auth::user()->hasRole('Admin'))
                        <td style="text-align:center;" colspan="2" class="showreserv">
                          <a href="{{ route('showreservationadmins',$dp1->id) }}" class="button reservshow">Apskatīt rezervācijas</a>
                        </td>
                        @endif
                        <tr>
                          @if(Auth::check())
    
                          <td class="sliderbutton" @if(Auth::user()->hasRole('Admin') && !checkAuthor(Auth::user()->email,$dp1->id)) colspan="2" {{-- ja nav piekļuves pogai lai būtu centrēts --}}
                            style="text-align: center" @endif class="space">
                          @if(Auth::user()->hasRole('Admin'))
                         ...
                         <a href="{{ route('showreservationcreate',['id' => $dp1->id, 'extension' => $dp1->linkcode]) }}" class="button ">
                          ...
                          <td class="sliderbutton space"><a href="{{ route('showedit',$dp1->id) }}" class="button ">Rediģēt</a></td>
                          @else <td></td>
                          @endif
                          @else <td class="sliderbutton space"><a href="{{ route('showevent',$dp1->id) }}" class="button">Apskatīt</a>
                          @endif
                        </tr>
                      </tbody>
                      @endforeach
                ...
                <table class="eventtable">
                  ...
                  @else 
                        ...
                        <tbody>
                          ...
                          <td rowspan="2" class="top clickshow"><a class='divlink' href="{{ route('showevent',$dp2->id) }}"></a>
                            <div class="eventdate"> {{-- geteventdate,geteventd funckijas helpers.php failā lai korrekti izvadīt informāciju --}}
                          ...
                          <td rowspan="2" class="top space eventinfo clickshow">
                            <a class='divlink' href="{{ route('showevent',$dp2->id) }}"></a>
                            <h5>{{ $dp2->Title }}
                          ...
                          @if(Auth::user()->hasRole('Admin'))
                          <td style="text-align:center;" colspan="2" class="showreserv">
                            <a href="{{ route('showreservationadmins',$dp2->id) }}" class="button reservshow">Apskatīt rezervācijas</a>
                          </td>
                          @endif
                          <tr>
                            @if(Auth::check())
      
                            <td class="sliderbutton" @if(Auth::user()->hasRole('Admin') && !checkAuthor(Auth::user()->email,$dp2->id)) colspan="2" {{-- ja nav piekļuves pogai lai būtu centrēts --}}
                              style="text-align: center" @endif class="space">
                            @if(Auth::user()->hasRole('Admin'))
                           ...
                           <a href="{{ route('showreservationcreate',['id' => $dp2->id, 'extension' => $dp2->linkcode]) }}" class="button ">
                            ...
                            <td class="sliderbutton space"><a href="{{ route('showedit',$dp2->id) }}" class="button ">Rediģēt</a></td>
                            @else <td></td>
                            @endif
                            @else <td class="sliderbutton space"><a href="{{ route('showevent',$dp2->id) }}" class="button">Apskatīt</a>
                            @endif
                          </tr>
                        </tbody>
                        @endforeach
                  ...
                  <table class="eventtable">
                    ...
                    @else  
                          ...
                          <tbody>
                            ...
                            <td rowspan="2" class="top clickshow"><a class='divlink' href="{{ route('showevent',$dp3->id) }}"></a>
                              <div class="eventdate"> {{-- geteventdate,geteventd funckijas helpers.php failā lai korrekti izvadīt informāciju --}}
                            ...
                            <td rowspan="2" class="top space eventinfo clickshow">
                              <a class='divlink' href="{{ route('showevent',$dp3->id) }}"></a>
                              <h5>{{ $dp3->Title }}
                            ...
                            @if(Auth::user()->hasRole('Admin'))
                            <td style="text-align:center;" colspan="2" class="showreserv">
                              <a href="{{ route('showreservationadmins',$dp3->id) }}" class="button reservshow">Apskatīt rezervācijas</a>
                            </td>
                            @endif
                            <tr>
                              @if(Auth::check())
        
                              <td class="sliderbutton" @if(Auth::user()->hasRole('Admin') && !checkAuthor(Auth::user()->email,$dp3->id)) colspan="2" {{-- ja nav piekļuves pogai lai būtu centrēts --}}
                                style="text-align: center" @endif class="space">
                              @if(Auth::user()->hasRole('Admin'))
                             ...
                             <a href="{{ route('showreservationcreate',['id' => $dp3->id, 'extension' => $dp3->linkcode]) }}" class="button ">
                              ...
                              <td class="sliderbutton space"><a href="{{ route('showedit',$dp3->id) }}" class="button ">Rediģēt</a></td>
                              @else <td></td>
                              @endif
                              @else <td class="sliderbutton space"><a href="{{ route('showevent',$dp3->id) }}" class="button">Apskatīt</a>
                              @endif
                            </tr>
                          </tbody>
                          @endforeach
                    ...
                    <table class="eventtable">
                      ...
                      @else   
                            ...
                            <tbody>
                              ...
                              <td rowspan="2" class="top clickshow"><a class='divlink' href="{{ route('showevent',$dp4->id) }}"></a>
                                <div class="eventdate"> {{-- geteventdate,geteventd funckijas helpers.php failā lai korrekti izvadīt informāciju --}}
                              ...
                              <td rowspan="2" class="top space eventinfo clickshow">
                                <a class='divlink' href="{{ route('showevent',$dp4->id) }}"></a>
                                <h5>{{ $dp4->Title }}
                              ...
                              @if(Auth::user()->hasRole('Admin'))
                              <td style="text-align:center;" colspan="2" class="showreserv">
                                <a href="{{ route('showreservationadmins',$dp4->id) }}" class="button reservshow">Apskatīt rezervācijas</a>
                              </td>
                              @endif
                              <tr>
                                @if(Auth::check())
          
                                <td class="sliderbutton" @if(Auth::user()->hasRole('Admin') && !checkAuthor(Auth::user()->email,$dp4->id)) colspan="2" {{-- ja nav piekļuves pogai lai būtu centrēts --}}
                                  style="text-align: center" @endif class="space">
                                @if(Auth::user()->hasRole('Admin'))
                               ...
                               <a href="{{ route('showreservationcreate',['id' => $dp4->id, 'extension' => $dp4->linkcode]) }}" class="button ">
                                ...
                                <td class="sliderbutton space"><a href="{{ route('showedit',$dp4->id) }}" class="button ">Rediģēt</a></td>
                                @else <td></td>
                                @endif
                                @else <td class="sliderbutton space"><a href="{{ route('showevent',$dp4->id) }}" class="button">Apskatīt</a>
                                @endif
                              </tr>
                            </tbody>
                            @endforeach
                      ...
                      <table class="eventtable">
                        ...
                        @else   
                              ...
                              <tbody>
                                ...
                                <td rowspan="2" class="top clickshow"><a class='divlink' href="{{ route('showevent',$dp5->id) }}"></a>
                                  <div class="eventdate"> {{-- geteventdate,geteventd funckijas helpers.php failā lai korrekti izvadīt informāciju --}}
                                ...
                                <td rowspan="2" class="top space eventinfo clickshow">
                                  <a class='divlink' href="{{ route('showevent',$dp5->id) }}"></a>
                                  <h5>{{ $dp5->Title }}
                                ...
                                @if(Auth::user()->hasRole('Admin'))
                                <td style="text-align:center;" colspan="2" class="showreserv">
                                  <a href="{{ route('showreservationadmins',$dp5->id) }}" class="button reservshow">Apskatīt rezervācijas</a>
                                </td>
                                @endif
                                <tr>
                                  @if(Auth::check())
            
                                  <td class="sliderbutton" @if(Auth::user()->hasRole('Admin') && !checkAuthor(Auth::user()->email,$dp5->id)) colspan="2" {{-- ja nav piekļuves pogai lai būtu centrēts --}}
                                    style="text-align: center" @endif class="space">
                                  @if(Auth::user()->hasRole('Admin'))
                                 ...
                                 <a href="{{ route('showreservationcreate',['id' => $dp5->id, 'extension' => $dp5->linkcode]) }}" class="button ">
                                  ...
                                  <td class="sliderbutton space"><a href="{{ route('showedit',$dp5->id) }}" class="button ">Rediģēt</a></td>
                                  @else <td></td>
                                  @endif
                                  @else <td class="sliderbutton space"><a href="{{ route('showevent',$dp5->id) }}" class="button">Apskatīt</a>
                                  @endif
                                </tr>
                              </tbody>
                              @endforeach
