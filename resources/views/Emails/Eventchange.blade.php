														...
														<table class="center" cellpadding="0" cellspacing="0">
															<tr>
																<td style="line-height:0;">
																	<a target="_blank" style="text-decoration:none;" href="{{url('/')}}"><img src="{{ public_path()}}\latvenergo-logo.png" border="0" style="font:bold 12px/12px Arial, Helvetica, sans-serif; color:#606060;" align="left" vspace="0" hspace="0" width="160px" alt="Latvenergo" /></a>
																</td>
															</tr>
														</table>
													</th>
					...
					<table data-module="module-2" data-thumb="thumbnails/02.png" width="100%" cellpadding="0" cellspacing="0">
						<tr>
							<td data-bgcolor="bg-module" bgcolor="#eaeced">
								<table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
									<tr>
										<td class="img-flex"><img src="{{ public_path()}}\img-01.jpg" style="vertical-align:top;" width="600" height="306" alt="" /></td>
									</tr>
									<tr>
